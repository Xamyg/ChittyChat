...
To easily run 3 clients simultaneously, use --name=Triple. This will open 3 terminals with the names, Johan, Xander and Bob (Must be run from a terminal in "ChittyChat/Handin 3" and requires access to either cmd for Windows or the GNOME terminal for Linux and MacOS. Will not work for WSL).
